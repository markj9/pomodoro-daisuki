...
require.register("collections/columns", function(exports, require, module) {
...
require.register("collections/pomodoros", function(exports, require, module) {
...
require.register("collections/states", function(exports, require, module) {
...
require.register("models/column", function(exports, require, module) {
var Column, Model,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.register("models/pomodoro", function(exports, require, module) {
var Model, Pomodoro,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.register("models/timer_config", function(exports, require, module) {
...
require.register("views/columns_view", function(exports, require, module) {
...
require.register("views/new_column_view", function(exports, require, module) {
...
require.register("views/new_note_view", function(exports, require, module) {
...
require.register("views/resting_view", function(exports, require, module) {
...
;require.register("views/templates/columns", function(exports, require, module) {
module.exports = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
;require.register("views/templates/new_column", function(exports, require, module) {
module.exports = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
;require.register("views/templates/new_note", function(exports, require, module) {
module.exports = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
;require.register("views/templates/options", function(exports, require, module) {
module.exports = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
require.register("views/working_view", function(exports, require, module) {
...
module.exports = WorkingView = (function(_super) {
  ...
  WorkingView.prototype.pauseResumeTimer = function() {
    $("#timer").pauseResumeTimer();
    if ($("#pauseResume").text() === "pause") {
      return $("#pauseResume").text("resume");
    } else {
      return $("#pauseResume").text("pause");
    }
  };
